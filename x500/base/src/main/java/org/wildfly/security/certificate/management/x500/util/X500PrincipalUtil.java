...
import org.wildfly.security.certificate.management.asn1.ASN1Decoder;
import org.wildfly.security.certificate.management.asn1.DERDecoder;
import org.wildfly.security.certificate.management.x500._private.CertMgmtMessages;
...
public final class X500PrincipalUtil {
    ...
    static {
        ...
        try {
             ...
             */
            CertMgmtMessages.log.trace("X550Name.asX500Principal() is not available.", t);
        }
    ...
    public static String[] getAttributeValues(X500Principal principal, String oid, boolean reverse) {
        ...
        if (decoder.hasNextElement()) {
            throw CertMgmtMessages.log.unexpectedTrailingGarbageInX500principal();
        }
    ...
    public static X500Principal asX500Principal(Principal principal, boolean convert) {
        ...
        if (convert) {
            try {
                ...
                CertMgmtMessages.log.trace("Unable to convert to X500Principal", ignored);
            }
        }
