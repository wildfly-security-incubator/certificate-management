...
public final class SelfSignedX509CertificateAndSigningKey {
    ...
    public static class Builder {
        ...
        public X509CertificateExtension addOrReplaceExtension(boolean critical, String extensionName, String extensionValue) {
            Assert.checkNotNullParam("name", extensionName);
            return addOrReplaceExtension(CertUtil.getX509CertificateExtension(critical, extensionName, extensionValue));
        }
        ...
        public SelfSignedX509CertificateAndSigningKey build() throws IllegalArgumentException {
            if (dn == null) {
                throw CertMgmtMessages.log.noDnGiven();
            }
            ...
            try {
                ...
                if (signatureAlgorithmName == null) {
                    ...
                    if (signatureAlgorithmName == null) {
                        throw CertMgmtMessages.log.unableToDetermineDefaultCompatibleSignatureAlgorithmName(signingKey.getAlgorithm());
                    }
                }

                // add the Subject Key Identifier extension if it's not already present
                final X509CertificateExtension subjectKeyIdentifierExtension = new SubjectKeyIdentifierExtension(KeyUtil.getKeyIdentifier(keyPair.getPublic()));
                ...
                throw CertMgmtMessages.log.selfSignedCertificateGenerationFailed(e);
            }
        }
    }
}
